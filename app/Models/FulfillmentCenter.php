...
class FulfillmentCenter extends Model
{
    ...
    protected $fillable = array('company_id','code','name','pic','phone','mobile','fax','email','address','address2','country','province','city','area','sub_area','postal_code','village','status','remarks','longitude','latitude');
